...
/**
 * V1GroupsSetAnnouncementBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1GroupsSetAnnouncementBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_groups_setAnnouncement_body';
     ...
     * Sets announcement
     *
     * @param string $announcement The announcement to set for the private group.
     *
     * @return $this
     */
