...
/**
 * V1GroupsCreateBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1GroupsCreateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_groups_create_body';
     ...
     * Sets read_only
     *
     * @param bool $read_only Set if the private channel is read-only or not. The default value is false.
     *
     * @return $this
     */
     ...
     * Sets members
     *
     * @param string[] $members The users to add to the private channel when it is created.
     *
     * @return $this
     */
     ...
     * Sets exclude_self
     *
     * @param bool $exclude_self If set to true, the user calling the endpoint is not added as a member of the private channel. The default value is false.
     *
     * @return $this
     */
     ...
     * Sets custom_fields
     *
     * @param object $custom_fields If you have defined custom fields for your workspace, you can provide them in this object parameter.
     *
     * @return $this
     */
