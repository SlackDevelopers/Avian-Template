...
/**
 * V1GroupsRemoveModeratorBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1GroupsRemoveModeratorBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_groups_removeModerator_body';
     ...
     * Sets user_id
     *
     * @param string $user_id The ID of the user to be removed from moderator role.
     *
     * @return $this
     */
