...
class PasswordPolicyApi
{
     ...
     * @return object
     */
    public function getPwGetPolicy($x_user_id, $x_auth_token)
    {
        list($response) = $this->getPwGetPolicyWithHttpInfo($x_user_id, $x_auth_token);
        return $response;
    }
     ...
     */
    public function getPwGetPolicyWithHttpInfo($x_user_id, $x_auth_token)
    {
        $returnType = 'object';
        $request = $this->getPwGetPolicyRequest($x_user_id, $x_auth_token);
     ...
     */
    public function getPwGetPolicyAsync($x_user_id, $x_auth_token)
    {
        return $this->getPwGetPolicyAsyncWithHttpInfo($x_user_id, $x_auth_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPwGetPolicyAsyncWithHttpInfo($x_user_id, $x_auth_token)
    {
        $returnType = 'object';
        $request = $this->getPwGetPolicyRequest($x_user_id, $x_auth_token);
     ...
     */
    protected function getPwGetPolicyRequest($x_user_id, $x_auth_token)
    {
