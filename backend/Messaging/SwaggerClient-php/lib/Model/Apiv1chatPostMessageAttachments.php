...
/**
 * Apiv1chatPostMessageAttachments Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Apiv1chatPostMessageAttachments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'apiv1chat.postMessage_attachments';
     ...
     * Sets audio_url
     *
     * @param string $audio_url Audio file to attach. See the <a href='https://developer.mozilla.org/en-US/docs/Web/HTML/Element/audio'>HTML audio element</a> for information.
     *
     * @return $this
     */
     ...
     * Sets author_link
     *
     * @param string $author_link Providing this makes the author's name clickable and points to the provided link.
     *
     * @return $this
     */
     ...
     * Sets color
     *
     * @param string $color See <a href='https://developer.mozilla.org/en-US/docs/Web/CSS/background-color'>background-css</a> for the supported colors.'
     *
     * @return $this
     */
     ...
     * Sets message_link
     *
     * @param string $message_link Only applicable if the `ts` field is provided, as it makes the time clickable to this link.
     *
     * @return $this
     */
     ...
     * Sets video_url
     *
     * @param string $video_url Video file to attach. See the <a href='https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video'>HTML video element</a> for information.
     *
     * @return $this
     */
