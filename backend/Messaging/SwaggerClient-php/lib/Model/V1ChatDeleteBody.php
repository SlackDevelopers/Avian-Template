...
/**
 * V1ChatDeleteBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1ChatDeleteBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1_chat_delete_body';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['as_user'] = isset($data['as_user']) ? $data['as_user'] : null;
    }
     ...
     * Sets as_user
     *
     * @param bool $as_user Should the message be deleted as the user who sent it? It is `false` by default.
     *
     * @return $this
     */
