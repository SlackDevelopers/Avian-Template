...
/**
 * LivechatRoomForwardBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LivechatRoomForwardBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'livechat_room_forward_body';
     ...
     * Sets user_id
     *
     * @param string $user_id The new agent ID.
     *
     * @return $this
     */
     ...
     * Sets department_id
     *
     * @param string $department_id The new department ID.
     *
     * @return $this
     */
