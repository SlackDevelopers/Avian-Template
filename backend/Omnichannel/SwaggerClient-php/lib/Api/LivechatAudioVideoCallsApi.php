...
class LivechatAudioVideoCallsApi
{
     ...
     */
    public function getApiV1LivechatWebrtcCall($x_auth_token, $x_user_id, $rid)
    {
        list($response) = $this->getApiV1LivechatWebrtcCallWithHttpInfo($x_auth_token, $x_user_id, $rid);
        return $response;
    }
     ...
     */
    public function getApiV1LivechatWebrtcCallWithHttpInfo($x_auth_token, $x_user_id, $rid)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20042';
        $request = $this->getApiV1LivechatWebrtcCallRequest($x_auth_token, $x_user_id, $rid);
     ...
     */
    public function getApiV1LivechatWebrtcCallAsync($x_auth_token, $x_user_id, $rid)
    {
        return $this->getApiV1LivechatWebrtcCallAsyncWithHttpInfo($x_auth_token, $x_user_id, $rid)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApiV1LivechatWebrtcCallAsyncWithHttpInfo($x_auth_token, $x_user_id, $rid)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20042';
        $request = $this->getApiV1LivechatWebrtcCallRequest($x_auth_token, $x_user_id, $rid);
     ...
     */
    protected function getApiV1LivechatWebrtcCallRequest($x_auth_token, $x_user_id, $rid)
    {
     ...
     * @param  \Swagger\Client\Model\WebrtcCallCallIdBody $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\InlineResponse20043
     */
    public function putApiV1LivechatWebrtcCallCallId($x_auth_token, $x_user_id, $call_id, $body = null)
    {
        list($response) = $this->putApiV1LivechatWebrtcCallCallIdWithHttpInfo($x_auth_token, $x_user_id, $call_id, $body);
        return $response;
    }
     ...
     * @param  string $x_user_id The &#x60;userId&#x60; of the authenticated user. (required)
     * @param  string $call_id The call message _id. (required)
     * @param  \Swagger\Client\Model\WebrtcCallCallIdBody $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\InlineResponse20043, HTTP status code, HTTP response headers (array of strings)
     */
    public function putApiV1LivechatWebrtcCallCallIdWithHttpInfo($x_auth_token, $x_user_id, $call_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20043';
        $request = $this->putApiV1LivechatWebrtcCallCallIdRequest($x_auth_token, $x_user_id, $call_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putApiV1LivechatWebrtcCallCallIdAsync($x_auth_token, $x_user_id, $call_id, $body = null)
    {
        return $this->putApiV1LivechatWebrtcCallCallIdAsyncWithHttpInfo($x_auth_token, $x_user_id, $call_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putApiV1LivechatWebrtcCallCallIdAsyncWithHttpInfo($x_auth_token, $x_user_id, $call_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse20043';
        $request = $this->putApiV1LivechatWebrtcCallCallIdRequest($x_auth_token, $x_user_id, $call_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putApiV1LivechatWebrtcCallCallIdRequest($x_auth_token, $x_user_id, $call_id, $body = null)
    {
        // verify the required parameter 'x_auth_token' is set
        if ($x_auth_token === null || (is_array($x_auth_token) && count($x_auth_token) === 0)) {
            throw new \InvalidArgumentException(
