...
<template>
  <div class="relative flex justify-center items-center">
    <input
      ...
      "
      :checked="props.value"
      class="h-5 w-5 appearance-none relative cursor-pointer outline-none rounded-[.3125rem] border border-rose-300 transition-all duration-300"
    />
    <CheckIcon
      @click="
        () => {
